...
project = u'darwintools'
copyright = u'2012-, MITgcm contributors'
# When updating the list of authors, remember to also
# change the LaTeX list below and the list in index.rst
author = u'Ed Doddridge, Oliver Jahn, Martin Losch, Estanislao Gavilan Pascual-Ahuir'
...
htmlhelp_basename = 'darwintoolsdoc'
...
latex_documents = [
    (master_doc, 'MITgcm.tex', u'MITgcm Documentation',
     u'Ed Doddridge, Oliver Jahn, Martin Losch, Estanislao Gavilan Pascual-Ahuir', 'manual'),
]
...
man_pages = [
    (master_doc, 'mitgcm', u'Darwintools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'darwintools', u'Darwintools Documentation',
     author, 'darwintools', 'Python tools for Darwin and MITgcm.',
     'Miscellaneous'),
]
